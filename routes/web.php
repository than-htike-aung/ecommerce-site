...
Route::prefix('shipping')->group(function () {
    ...
    Route::get('/district/{id}', [ShippingAreaController::class, 'DistrictDelete'])->name('district.delete');
    ...
    Route::get('/state/{id}', [ShippingAreaController::class, 'StateDelete'])->name('state.delete');
});
