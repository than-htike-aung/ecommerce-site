...
<div class="row"> <!-- start 2nd row  -->
	...
	<div class="controls">
	 ...
	 @enderror
			...
			<div class="controls">
				<input type="text" name="product_name_my" value="{{$product->product_name_my}}" class="form-control" required="">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="product_tags_my" class="form-control" value="{{$product->product_tags_my}}" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_color_my" class="form-control" value="{{$product->product_color_my}}" data-role="tagsinput" required="">
...
<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Update Product">
		...
		<section class="content">
			<div class="row">
									...
									<div class="card-body">
									  ...
									  <p class="card-text">
										  <div class="form-group">
											...
											<input type="file" class="form-control" title="file" name="multi_img[{{$img->id}}]">
										  </div>
									  </p>
				...
				{{-- /////////// Single Image Update Area Start ////////// --}}
