                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <td>Blog Category English</td>

                                        <th>Blog Category Myanmar</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('blog.category.edit',$item->id)}}" class="btn btn-info"><i
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <form action="{{route('blogcategory.store')}}" method="post">
                                ...
                                <div class="form-group">
                                    <h5>Blog Category Myanmar <span class="text-danger">*</span></h5>
                                    <div class="controls">
