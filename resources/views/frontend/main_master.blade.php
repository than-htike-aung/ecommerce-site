...
<body class="cnt-home">
  ...
  <script type="{{asset('frontend/text/javascript')}}" src="{{asset('assets/js/lightbox.min.js')}}"></script>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="qty" value="1" min="1" name="">
              </div> <!-- End form group -->
            ...
            <td class="col-md-2">
              ${value.qty > 1
                ...
                : ` <button type="submit" class="btn btn-danger btn-sm" disabled>-</button>`
				      ...
				      <input type="text" value="${value.qty}" min="1" max="10" style="width: 25px" disabled=""> 
