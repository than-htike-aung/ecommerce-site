        ...
        <div class="cnt-account">
          <ul class="list-unstyled">
            <li><a href="#"><i class="icon fa fa-user"></i>
                @If(session()->get('language') == 'myanmar') Account အမည် @else My Account @endif
              </a></li>
          ...
          <ul class="list-unstyled list-inline">
            ...
            <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown"
                data-toggle="dropdown"><span class="value">
                  @if(session()->get('language') == 'myanmar') ြမန်မာ
                  @else Language @endif
              ...
              <ul class="dropdown-menu">
                ...
                @else
                @endif
                <li><a href="{{route('myanmar.language')}}">Myanmar</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
          ...
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="{{url('/')}}" style="font-size: 20px; color:green"> <img
                src="{{ asset($setting->logo) }}" alt="logo"> Online Shop
            </a> </div>
          <!-- /.logo -->
          <!-- ============================================================= LOGO : END ============================================================= -->
        </div>
            ...
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                <li class="active dropdown yamm-fw"> <a href="{{url('/')}}" data-hover="dropdown"
                    ...
                    @if(session()->get('language') == 'myanmar') ပင်မနေရာ @else Home @endif
                  </a> </li>
                      ...
                      <div class="yamm-content ">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            ...
                            $subcategory->id)->orderBy('subsubcategory_name_en', 'ASC')->get();
                            @endphp
