  ...
  <div class='container'>
    <div class='row'>
                  ...
                  <div class="accordion-group">
                    ...
                    <div class="accordion-body collapse" id="collapse{{$category->id}}" style="height: 0px;">
                      <div class="accordion-inner">
                        ...
                        @endphp @foreach($subcategories as $subcategory)
                        <ul>
                          <li><a href="#">
                              @if(session()->get('language') == 'myanmar')
      ...
      <div class='col-md-9'>
        ...
        @foreach($breadsubsubcat as $item)
        <span class="badge badge-danger" style="background: #808080">{{ $item->subcategory->subcategory_name_en
          }}</span>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          ...
                          @else
                          <div class="tag hot"><span>{{round($discount)}} %<br>off</span></div>
                          @endif
