								...
								<div class="panel-body">
									<div class="row">
											...
											<form class="register-form" action="{{ route('checkout.store') }}"
												...
												<div class="form-group">
													<label class="info-title"
														for="exampleInputEmail1">Email<span>*</span></label>
												...
												<div class="form-group">
													<label class="info-title"
														for="exampleInputEmail1">Phone<span>*</span></label>
													<input type="number" required="" name="shipping_phone"
														class="form-control unicase-form-control text-input"
												...
												<div class="form-group">
													<label class="info-title" for="exampleInputEmail1">Post
										...
										<div class="col-md-6 col-sm-6 already-registered-login">
											...
											<div class="form-group">
												<label class="info-title"
													for="exampleInputEmail1">Notes<span>*</span></label>
