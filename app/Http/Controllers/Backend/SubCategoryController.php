...
class SubCategoryController extends Controller
{
    ...
    public function SubCategoryStore(Request $request){
        ...
        SubCategory::insert([
            ...
            'subcategory_slug_my' => strtolower(str_replace(' ', '-', $request->subcategory_name_my))
        ]);
        $notification = array(
   ...
   // For All SubSubCategories //
    ...
    public function SubSubCategoryStore(Request $request){
        ...
        SubSubCategory::insert([
            ...
            'subsubcategory_slug_my' => strtolower(str_replace(' ', '-', $request->subsubcategory_name_my))
        ]);
        $notification = array(
